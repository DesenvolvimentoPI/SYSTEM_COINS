                ...
                <header className="header">
                    <div className="inner-header">
                        ...
                        <div className="menu-icon" onClick={toggleMenu}>
                            <i className="bi bi-list"></i> {/* Assumes you have Bootstrap Icons */}
                        </div>
                    </div>

                    {/* Mobile Navbar */}
                    <nav className={`mobile-navbar ${isMenuOpen ? 'menu-active' : ''}`}>
                        <div className="close-menu" onClick={toggleMenu}>
                            <i className="bi bi-x"></i> {/* Assumes you have Bootstrap Icons */}
                        </div>
                        <ul>
                            <li><Link to='/tipo' onClick={toggleMenu}>Login</Link></li>
                            <li><Link to='/Alunos' onClick={toggleMenu}>Teste</Link></li>
                    ...
                    <div className="banner active">
                        ...
                        <p>Conquiste o sucesso acadêmico e seja recompensado! Se esforce, aprenda e destaque-se para alcançar seus objetivos e ganhar prêmios incríveis. Seu futuro começa agora!</p>
                    </div>
                </header>
